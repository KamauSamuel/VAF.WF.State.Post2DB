...
# Application details
$appFilePath = "\bin\Debug\WAICAK.PettyCashReimbursement.PettyCashRequisitions.mfappx"
$appGuid = "92974170-e7dd-4412-9416-e973b6a97f2d"

# Target vault
$vaultName = "WAICAK_Test"

# Connection details 
$authType = [MFilesAPI.MFAuthType]::MFAuthTypeSpecificWindowsUser
$userName = "ke_admin"
$password = "Bunkprugu0!"
$domain = "KENBOSRV01"
$spn = ""
